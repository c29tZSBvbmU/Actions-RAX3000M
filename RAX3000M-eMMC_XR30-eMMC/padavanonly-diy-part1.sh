...
mkdir modeminfo
mkdir luci-app-modeminfo
cp -rf ../Modemfeed/luci/applications/luci-app-modeminfo/* luci-app-modeminfo
cp -rf ../Modemfeed/packages/net/modeminfo/* modeminfo



#fm350 老毛子拨号 L860gl xmmmodem拨号
...
mkdir luci-proto-xmm
mkdir xmm-modem
cp -rf ../Modemfeed/luci/protocols/luci-proto-xmm/* luci-proto-xmm
cp -rf ../Modemfeed/packages/net/xmm-modem/* xmm-modem
popd
